  ...
  from (
    values
      ...
      (
        ...
        'PETC / Falcon',
        'Special Assistance',
        jsonb_build_array('Contact Centre', 'Supervisor', 'Reservations Support', $seed$Airport / DXB Sales for go-show handling$seed$),
        ...
        jsonb_build_array('Contact Centre agent', 'Contact Centre supervisor', 'Reservations Support', 'Airport representative for accepted go-show falcons', $seed$DXB Sales team for DXB/DWC go-show bookings$seed$),
      ...
      (
        ...
        'LNGL / OLCI Lounge',
        'Check-in',
        jsonb_build_array('Website', 'Online Check-in', $seed$DXB Terminal 2 subject to availability$seed$),
        ...
        jsonb_build_array($seed$Available to passengers travelling or connecting with flydubai from DXB Terminal 2 during OLCI via flydubai website.$seed$, 'Available for Economy passengers.', 'Available for passengers upgraded to J class via OLCI or Plusgrade.', 'Available for ID50 bookings in J and Y class.', 'Can be purchased for one or multiple passengers in the same booking during OLCI.', 'All forms of payment are applicable.', 'Infants receive complimentary access when accompanied by an eligible adult.'),
      ...
      (
        ...
        jsonb_build_array('Refer missing interline excess baggage rates to shift in charge.', 'Use dnata transfer desk for connecting flight boarding pass where applicable.', $seed$Passenger must clear immigration and re-check in at DXB/DWC for excluded carrier arrivals listed in source.$seed$),
