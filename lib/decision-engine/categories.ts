...
export const WORKFLOW_CATEGORIES: Record<string, WorkflowCategory> = {
  ...
  "meet-assist": "Airport",
  "business-lounge": "Airport",
  "blue-ribbon-bags": "Airport",
  worldtracer: "Airport",
  meda: "Medical",
  "death-case": "Medical",
  oxygen: "Medical",
  "plaster-cast-leg-brace": "Medical",
  dpna: "Special Services",
  "service-animal": "Special Services",
  "human-remains": "Special Services",
