...
const CODE_ALIASES: Record<string, string[]> = {
  ...
  // v81.7 additions (SPEX retired 01-Aug-2026 and intentionally absent).
  BIKE: ["bicycle", "sporting equipment"],
  WEAP: ["firearms", "ammunition", "weapon approval"],
  OOGS: ["out of gauge", "oversized baggage"],
  OOGL: ["out of gauge", "oversized baggage"],
  OBAG: ["oversized hand baggage"],
  HBAG: ["overweight hand baggage"],
  TVCH: ["television", "tv charge", "baggage"],
  LMAJ: ["al majlis", "vip service"],
  XBAG: ["excess baggage"],
  BAGG: ["baggage"],
...
const SEARCH_ALIASES: Record<string, string[]> = {
  // Natural-language intents -> operational vocabulary (search hints only)
  "cannot walk": ["wheelchair", "wchr"],
  "can't walk": ["wheelchair", "wchr"],
  "passenger cannot walk": ["wheelchair", "wchr"],
  "reduced mobility": ["wheelchair", "wchr", "special assistance"],
  "medical assistance": ["medical", "meda", "special assistance"],
  "missed flight": ["no show", "flight disruption", "go show"],
  "missed departure": ["no show", "flight disruption"],
  "late passenger": ["no show", "check-in closure"],
  "no show": ["no show", "go show", "fare rules"],
  "broken leg": ["plaster cast", "leg brace"],
  "plaster cast": ["plaster cast", "leg brace"],
  pregnant: ["pregnancy"],
  blind: ["visual impairment", "blnd"],
  deaf: ["hearing impairment", "deaf"],
  "guide dog": ["service animal", "svan"],
  "lost bag": ["worldtracer", "delayed baggage"],
  "lost baggage": ["worldtracer", "delayed baggage"],
  "damaged bag": ["worldtracer", "damaged baggage"],
  "musical instrument": ["cbbg", "extra seat", "cabin baggage seat"],
  "valuable item": ["cbbg", "extra seat"],
  "money back": ["refund", "voucher"],
  "cash refund": ["refund", "voucher"],
  "cannot pay": ["payment", "payment failure", "cchk"],
  "card declined": ["payment failure", "cchk", "card verification"],
  ...
  // v81.7 topics
  "out of gauge": ["out of gauge", "oversized baggage", "oogs", "oogl"],
  "oversized baggage": ["out of gauge", "oversized baggage", "oogs", "oogl"],
  television: ["television", "tvch", "baggage"],
  "tv charge": ["television", "tvch", "baggage"],
  "al majlis": ["al majlis", "vip service", "lmaj"],
  champagne: ["champagne", "special requests", "spml"],
